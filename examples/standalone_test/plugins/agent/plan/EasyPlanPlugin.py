...
- If no one interesting is nearby, move to explore (pick a random position)
- Say something meaningful related to your personality, not just greetings
- Keep chat content under 20 words

Respond with ONE JSON action:
{{"action":"move", "target":[x, y]}}
or
{{"action":"chat", "target":"agent_id", "content":"your message"}}'''
